...
import lam.eshop.model.OrderInfo;
import lam.eshop.pagination.PaginationResult;
import lam.eshop.validator.ProductFormValidator;
...
public class AdminController {
    ...
    public String product(Model model, @RequestParam(value = "code", defaultValue = "") String code) {
        System.out.println("Getting product form");
        ...
        if (productForm == null) {
            ...
            productForm.setGallery(productDAO.getGalleryByProduct(code));
        }
